...
router.get('/folder/:id', authentication, filesValidation.verifyPassword, dModule.GetFileAndFolder);
...
router.delete('/folder/:id', authentication, filesValidation.verifyPassword, dModule.DeleteFolder);
